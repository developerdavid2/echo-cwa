...
import { useInfiniteScrollWithHook } from "@workspace/ui/hooks/use-infinite-scroll";
import { InfiniteScrollTrigger } from "@workspace/ui/components/infinite-scroll-trigger";
import { DicebearAvatar } from "./../../../../../packages/ui/src/components/dicebear-avatar";
import { ChatMessageSkeleton } from "./../../../../../packages/ui/src/components/ai/chat-message-skeleton";
...
const ChatContent = ({
  ...
  sentryRef: (node: HTMLDivElement | null) => void;
}) => {
...
export const WidgetChatScreen = () => {
  ...
  const { sentryRef, canLoadMore, isLoadingMore } = useInfiniteScrollWithHook({
    status: messages.status,
    loadMore: messages.loadMore,
    loadSize: 4,
    rootMargin: "200px 0px 0px 0px", // Trigger before reaching top
  });
